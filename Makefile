...
DISTDIR = /home/antoine/Documents/ProjetAnimal/.tmp/main.exe1.0.0
LINK          = g++
...
Animal.o: src/Animal.cpp include/Animal.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Animal.o src/Animal.cpp

Gazelle.o: src/Gazelle.cpp include/Gazelle.h \
		include/Animal.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Gazelle.o src/Gazelle.cpp

Lion.o: src/Lion.cpp include/Lion.h \
		include/Animal.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Lion.o src/Lion.cpp
